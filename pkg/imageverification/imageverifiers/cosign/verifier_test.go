		...
		Cosign: &v1alpha1.Cosign{
			Keyless: &v1alpha1.Keyless{
				Identities: []v1alpha1.Identity{
					{
						Issuer:  &v1alpha1.StringOrExpression{Value: "https://github.com/login/oauth"},
						Subject: &v1alpha1.StringOrExpression{Value: "jim@nirmata.com"},
					},
				},
			},
		...
		Cosign: &v1alpha1.Cosign{
			Keyless: &v1alpha1.Keyless{
				Identities: []v1alpha1.Identity{
					{
						Issuer:  &v1alpha1.StringOrExpression{Value: "https://github.com/login/oauth"},
						Subject: &v1alpha1.StringOrExpression{Value: "jim@invalid.com"},
					},
				},
			},
			CTLog: &v1alpha1.CTLog{
